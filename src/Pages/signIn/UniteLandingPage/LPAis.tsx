            ...
            <Slide direction="up" in timeout={2000}>
                ...
                >
                    ...
                    <Typography variant="body1" textAlign="center" maxWidth="600px">
                        AISはあなただけの秘書として、<br/>
                        日々の雑務から組織内のデータ分析、<br/>
                        戦略立案をはじめとするコンサルタントを担います。<br/>
                        あなたは自分のビジョンの実現に専念できます。<br/>
                        AISは強力な右腕となってあなたをサポートします。
                    </Typography>
                </Box>
            </Slide>
                        ...
                        <Slide direction="left" in timeout={800}>
                            <Paper elevation={3} sx={{ padding: 4, height: '100%', backgroundColor: accentColor, color: textColor }}>
                                ...
                                <Typography variant="body2" color={primaryColor} mt={2}>
                                    <li>CASE1：タグを活用したコンテンツの最適化</li>
                                    <li>CASE2：好奇心が作る小集団</li>
                                    <li>CASE3：組織と個人のベクトルを揃える</li>
                                </Typography>
                            </Paper>
                        </Slide>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={4}>
                        <Slide direction="up" in timeout={800}>
                            <Paper elevation={3} sx={{ padding: 4, height: '100%', backgroundColor: accentColor, color: textColor }}>
                                ...
                                <Typography variant="body2" color={primaryColor} mt={2}>
                                    <li>CASE1：組織のナレッジベースとして活用する</li>
                                    <li>CASE2：メンバーに対しての深いインサイト</li>
                                    <li>CASE3：コンテンツマーケティングに活用する</li>
                                </Typography>
                            </Paper>
                        </Slide>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={4}>
                        <Slide direction="right" in timeout={800}>
                            <Paper elevation={3} sx={{ padding: 4, height: '100%', backgroundColor: accentColor, color: textColor }}>
                                ...
                                <Typography variant="body2" color={primaryColor} mt={2}>
                                    <li>CASE1：ワークフローの自動化</li>
                                    <li>CASE2：勤怠管理・報告を任せる</li>
                                    <li>CASE3：雑談によるメンタルケア</li>
                                </Typography>
                            </Paper>
                        </Slide>
                    </Grid>
